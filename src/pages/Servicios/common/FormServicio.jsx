...
const FormServicio = ({ agregar }) => {
	...
	const { Nombre, Precio, Descripcion, Prioritario } = selectedService;
	const [inpNombre, setInpNombre] = useState(Nombre)
	const [inpPrecio, setInpPrecio] = useState(Precio)
	const [inpDescripcion, setInpDescripcion] = useState(Descripcion)
	const [inpPrioritario, setInpPrioritario] = useState(Prioritario)
	return (
		<div className="w-full flex flex-col">
			...
			<div className="flex flex-row w-full my-8">
				...
				<input 	defaultChecked={!Prioritario} id="checkbox" onChange={e => setInpPrioritario( e.target.checked ) }  type="checkbox" value="" class="sr-only peer" /> 				
